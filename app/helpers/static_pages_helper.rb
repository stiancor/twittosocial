module StaticPagesHelper
  ...
  def calculate_user_rank
    ...
    like_rank = Micropost.unscoped.select('microposts.user_id micropost_user_id, likes.user_id like_user_id').joins(:likes).where('microposts.created_at > ? and micropost_user_id != likes.user_id', Date.today.advance(days: -30)).to_a
